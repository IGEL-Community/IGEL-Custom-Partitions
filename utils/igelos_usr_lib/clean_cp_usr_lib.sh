...
#
# https://github.com/IGEL-Community/IGEL-Custom-Partitions/tree/master/utils/igelos_usr_lib
...
if [ $# -ne 2 ]; then
    ...
    echo "https://github.com/IGEL-Community/IGEL-Custom-Partitions/tree/master/utils/igelos_usr_lib"
    exit 1
fi

IGEL_USR_LIB_WGET="https://raw.githubusercontent.com/IGEL-Community/IGEL-Custom-Partitions/master/utils/igelos_usr_lib"
