...
APPARMOR="FALSE"
GETVERSION_FILE="$HOME/Downloads/ftsound-*-x86_64.tar.gz"
MISSING_LIBS_OS11=""
MISSING_LIBS_OS12=""
...
if ! compgen -G "${GETVERSION_FILE}" > /dev/null; then
  echo "***********"
  echo "Obtain Sound for Remote Desktop (Linux version) 64bit, save into $HOME/Downloads and re-run this script "
  echo "https://www.fabulatech.com/sound-over-rdp.html"
