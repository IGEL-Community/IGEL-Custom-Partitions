...
# user directories
USER_CONFIG="/userhome/.config/Appspace App"
...
init)
  ...
  # fix permissions
  chmod 4755 "${CP}/opt/Appspace App/chrome-sandbox"
  ...
  systemctl --no-block start igel-appspace-cp-apparmor-reload.service
