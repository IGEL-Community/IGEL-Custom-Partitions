...
ZIP_FILE="Fabulatech_AVD_Serial_Port"
FIX_MIME="FALSE"
CLEAN="FALSE"
...
APPARMOR="FALSE"
GETVERSION_FILE="$HOME/Downloads/ftspr-*-x86_64.tar.gz"
MISSING_LIBS_OS11=""
MISSING_LIBS_OS12=""
...
if ! compgen -G "${GETVERSION_FILE}" > /dev/null; then
  echo "***********"
  echo "Obtain Serial Port for Remote Desktop (Linux version) 64bit, save into $HOME/Downloads and re-run this script "
  echo "https://www.fabulatech.com/serial-port-for-remote-desktop-linux-packages.html"
...
VERSION=$(ls ${GETVERSION_FILE} | cut -d "-" -f 2)
