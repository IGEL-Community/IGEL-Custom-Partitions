...
#apt-get download libpswrappers

mkdir -p custom/picoscope

find . -name "*.deb" | while read LINE
do
  dpkg -x "${LINE}" custom/picoscope
done

mv custom/picoscope/usr/share/applications/ custom/picoscope/usr/share/applications.mime

wget https://github.com/IGEL-Community/IGEL-Custom-Partitions/raw/master/CP_Packages/Apps/PicoScope.zip

unzip PicoScope.zip -d custom
mv custom/target/picoscope-cp-init-script.sh custom

cd custom

tar cvjf picoscope.tar.bz2 picoscope picoscope-cp-init-script.sh
mv picoscope.tar.bz2 ../..
mv target/picoscope.inf ../..
mv igel/*.xml ../..
