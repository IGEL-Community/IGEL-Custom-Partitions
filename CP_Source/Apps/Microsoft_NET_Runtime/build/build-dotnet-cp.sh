...
# Creating an IGELOS CP for Microsoft .NET 7.0, 6.0, 5.0, or 3.1 Runtime
...
MISSING_LIBS_7_0="aspnetcore-runtime-7.0 dotnet-host dotnet-hostfxr-7.0 dotnet-runtime-7.0 dotnet-runtime-deps-7.0"
