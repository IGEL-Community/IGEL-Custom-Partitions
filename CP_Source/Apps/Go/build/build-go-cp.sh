...
USERHOME_FOLDERS_DIRS=("custom/${CP}/userhome/go" "custom/${CP}/userhome/go-source")
APPARMOR="FALSE"
GETVERSION_FILE="$HOME/Downloads/go*.linux-amd64.tar.gz"
MISSING_LIBS_OS11=""
MISSING_LIBS_OS12=""
...
if ! compgen -G "${GETVERSION_FILE}" > /dev/null; then
  echo "***********"
  echo "Obtain Go ${GETVERSION_FILE} for Linux (Linux version) 64bit, save into $HOME/Downloads and re-run this script "
