...
ZIP_FILE="Brother_Scanner_brscan5"
FIX_MIME="FALSE"
CLEAN="FALSE"
...
APPARMOR="FALSE"
GETVERSION_FILE_OS11="brscan5-1.3.10-5.amd64.deb"
GETVERSION_FILE_OS12="brscan5-1.3.10-5.amd64.deb"
WGET_URL="https://download.brother.com/welcome/dlf104033"
MISSING_LIBS_OS11=""
MISSING_LIBS_OS12=""
...
mv postinst ../brscan5_igel_postinst.sh
cd ..
...
tar cvjf target/${CP}.tar.bz2 ${CP} ${CP}-cp-init-script.sh brscan5_igel_postinst.sh
