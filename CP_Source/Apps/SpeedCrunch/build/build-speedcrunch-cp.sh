...
ZIP_FILE="SpeedCrunch"
FIX_MIME="TRUE"
CLEAN="FALSE"
OS11_CLEAN="11.08.330"
OS12_CLEAN="12.01.100"
USERHOME_FOLDERS="TRUE"
USERHOME_FOLDERS_DIRS="custom/speedcrunch/userhome/.config/SpeedCrunch custom/speedcrunch/userhome/.local/share/SpeedCrunch"
APPARMOR="FALSE"
GETVERSION_FILE="../../SpeedCrunch*.deb"
MISSING_LIBS_OS11=""
MISSING_LIBS_OS12=""
...
# SpeedCrunch-0.12-linux64.deb
if ! compgen -G "$HOME/Downloads/SpeedCrunch*.deb" > /dev/null; then
  echo "***********"
  echo "Download latest 64-bit .deb package and re-run this script"
  echo "https://heldercorreia.bitbucket.io/speedcrunch/download.html"
  echo "***********"
  exit 1
fi
...
cp $HOME/Downloads/SpeedCrunch*.deb .
