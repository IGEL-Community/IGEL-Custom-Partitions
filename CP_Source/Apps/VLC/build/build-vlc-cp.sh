...
if [ "${IGELOS_ID}" = "OS11" ]; then
  ...
  ./clean_cp_usr_lib.sh 12.01.100_usr_lib.txt custom/vlc/usr/lib
  ./clean_cp_usr_share.sh 12.01.100_usr_share.txt custom/vlc/usr/share
fi
...
mv ../VLC.zip ../../VLC-${VERSION}_${IGELOS_ID}_igel01.zip
