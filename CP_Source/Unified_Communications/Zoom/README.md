...
| Metadata File <br /> zoom.inf | [INFO] <br /> [PART] <br /> file="zoom.tar.bz2" <br /> version="5.6.1" <br /> size="400M" <br /> minfw="11.04.240" |
...
| Package automation | [build-zoom-cp.sh](build-zoom-cp.sh) <br /><br /> Tested with 5.6.1 (March 29, 2021)|
