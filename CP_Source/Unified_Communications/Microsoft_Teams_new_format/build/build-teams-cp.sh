...
wget https://github.com/IGEL-Community/IGEL-Custom-Partitions/raw/master/CP_Packages/Unified_Communications/Microsoft_Teams_new_format.zip
...
zip -g ../Microsoft_Teams_new_format.zip target/teams.tar.bz2 target/teams.inf
zip -d ../Microsoft_Teams_new_format.zip "target/build/*" "target/igel/*" "target/target/*"
mv ../Microsoft_Teams_new_format.zip ../../Microsoft_Teams-${VERSION}_igel01.zip
