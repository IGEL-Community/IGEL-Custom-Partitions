...
|  CP Information |            |
|--------------------|------------|
| Package | Zoom 5.3.465578.0920 <br /> [Download Zoom](https://zoom.us/download?os=linux)|
| Script Name | [zoom-cp-init-script.sh](zoom-cp-init-script.sh) |
| CP Mount Path | /custom/zoom |
| CP Size | 200M |
| IGEL OS Version (min) | 11.3.110 |
| Metadata File <br /> zoom-5.3.465578.0920.inf | [INFO] <br /> [PART] <br /> file="zoom_amd64_5.3.465578.0920.tar.bz2" <br /> version="5.3.465578.0920" <br /> size="200M" <br /> minfw="11.03.110" |
