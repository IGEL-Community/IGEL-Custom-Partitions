...
# Signal directory
USER_CONFIG="/userhome/.config/Signal"
...
init)
  ...
  systemctl --no-block start igel-signal-cp-apparmor-reload.service

  # after CP installation run wm_postsetup to activate signal.desktop mimetypes for SSO
