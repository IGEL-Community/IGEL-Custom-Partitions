...
wget https://github.com/IGEL-Community/IGEL-Custom-Partitions/raw/master/CP_Packages/Browsers/Google_Chrome_new.zip

unzip Google_Chrome_new.zip -d custom
...
zip -g ../Google_Chrome_new.zip target/chrome.tar.bz2 target/chrome.inf
zip -d ../Google_Chrome_new.zip "target/build/*" "target/igel/*" "target/target/*"
mv ../Google_Chrome_new.zip ../../Google_Chrome-${VERSION}_igel01.zip
