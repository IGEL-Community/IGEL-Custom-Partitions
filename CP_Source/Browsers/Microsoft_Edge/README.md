...
| Path to Executable | /custom/edge/usr/bin/microsoft-edge-dev |
| Path to Icon | /custom/edge/opt/microsoft/msedge-dev/product_logo_256_dev.png |
| Missing Libraries | None |
| Download package and missing library | apt-get download microsoft-edge-dev <br /> apt-get download libatomic1 |
...
| Package automation | [build-edge-cp.sh](build-edge-cp.sh) <br /><br /> Tested with 90.0.810.1
