...
wget https://github.com/IGEL-Community/IGEL-Custom-Partitions/raw/master/CP_Packages/Browsers/Microsoft_Edge_beta.zip

unzip Microsoft_Edge_beta.zip -d custom
...
zip -g ../Microsoft_Edge_beta.zip target/edge.tar.bz2 target/edge.inf
zip -d ../Microsoft_Edge_beta.zip "target/build/*" "target/igel/*" "target/target/*"
mv ../Microsoft_Edge_beta.zip ../../Microsoft_Edge_beta-${VERSION}_igel01.zip
